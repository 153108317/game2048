...
public class Card extends FrameLayout {
    ...
    public Card(Context context) {
        ...
        label.setBackgroundColor(getResources().getColor(R.color.colorAccent));
        setBackgroundColor(0x33ffffff);     //设置文字背景或颜色
...
//		LayoutParams lp = new LayoutParams(-1, -1);   //设置布局参数 填充满整个父级容器
        LayoutParams lp = new LayoutParams(200, 200);   //设置布局参数 填充满整个父级容器
